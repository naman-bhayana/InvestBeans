      ...
      <main className="container mx-auto px-6 py-16">
        {isAuthenticated && (
          <section className="mb-20 animate-fade-in">
            <div className="mb-6">
              <h2 className="text-4xl font-bold text-foreground mb-2">InvestBeans Live Premium Charts</h2>
              <p className="text-muted-foreground">Exclusive charts for subscribers</p>
            </div>
        ...
        <section className="mb-20 animate-fade-in">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-4xl font-bold text-foreground mb-2">Live Dashboard</h2>
              <p className="text-muted-foreground">Real-time market data at your fingertips</p>
            </div>
        ...
        <section className="mb-20">
          <div className="text-center mb-10">
            <h2 className="text-4xl font-bold text-foreground mb-3">Decode the Market</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Expert insights and analysis to help you understand market movements
            </p>
          </div>
        ...
        <section className="mb-20">
          <div className="text-center mb-10">
            <h2 className="text-4xl font-bold text-foreground mb-3">Beans of Wisdom</h2>
            <p className="text-muted-foreground">Quick bites of investment knowledge</p>
          </div>
            ...
            <div className="flex items-start gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-base text-muted-foreground leading-relaxed">
                  Earnings Per Share (EPS) represents a company's profitability divided by the number of outstanding shares. 
                  It's a key metric investors use to gauge a company's financial health and growth potential.
                </p>
        ...
        <section className="mb-20">
          <div className="text-center mb-10">
            <h2 className="text-4xl font-bold text-foreground mb-3">Deep Dives</h2>
            <p className="text-muted-foreground">In-depth analysis and market forecasts</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <DeepDiveCard 
